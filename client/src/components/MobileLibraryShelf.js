...
export default function MobileLibraryShelf ({ like, i  }) {
  ...
  return (
    <div className="media-row-container" key={i}>
      <div className="row-grid">
        <div className="row-content rank">
          <span>{i + 1}</span>
        </div>
        <button className="mobile-play-like" onClick={() => playLike(like.uri, device)}>
